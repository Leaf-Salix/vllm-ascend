...
def prepare_weights(impl, hadamard):
    ...
    w = {
        ...
        "cmp_norm_w": _native_tensor("cmp_norm_w", compressor.norm.weight.detach(), torch.bfloat16),
        "idx_wq_b": idx_wq_b,
        ...
        "inner_norm_w": _native_tensor("inner_norm_w", indexer.compressor.norm.weight.detach(), torch.bfloat16),
