...
task-submit "${DEV_ARGS[@]}" \
    ...
    --env PTO_CSA="${PTO_CSA:-}" \
    --env PTO_CSA_MODE="${PTO_CSA_MODE:-program}" \
    --env VLLM_ASCEND_PTO_CSA_SWIMLANE_LEVEL="${VLLM_ASCEND_PTO_CSA_SWIMLANE_LEVEL:-0}" \
    --env VLLM_ASCEND_PTO_CSA_SWIMLANE_DIR="${VLLM_ASCEND_PTO_CSA_SWIMLANE_DIR:-}" \
    --env VLLM_ASCEND_PTO_CSA_SWIMLANE_MAX_CAPTURES="${VLLM_ASCEND_PTO_CSA_SWIMLANE_MAX_CAPTURES:-1}" \
